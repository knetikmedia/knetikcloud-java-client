...
MediaVideosApi apiInstance = new MediaVideosApi();
Boolean excludeFlagged = true; // Boolean | Skip videos that have been flagged by the current user
Object filterVideosByUploader = null; // Object | Filter for videos by uploader id
...
Object filterVideosByContributor = null; // Object | Filter for videos with contribution from the artist specified by ID
Object filterVideosByAuthor = null; // Object | Filter for videos with an artist as author specified by ID
