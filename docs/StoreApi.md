...
# **getUsingGET2**
> PageStoreItem getUsingGET2(limit, page, useCatalog, ignoreLocation, inStockOnly)
...
try {
    PageStoreItem result = apiInstance.getUsingGET2(limit, page, useCatalog, ignoreLocation, inStockOnly);
    System.out.println(result);
} catch (ApiException e) {
