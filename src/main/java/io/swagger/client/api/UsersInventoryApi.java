...
public class UsersInventoryApi {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call grantEntitlementUsingPOSTValidateBeforeCall(Integer userId, EntitlementGrantRequest grantRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> grantEntitlementUsingPOSTWithHttpInfo(Integer userId, EntitlementGrantRequest grantRequest) throws ApiException {
        com.squareup.okhttp.Call call = grantEntitlementUsingPOSTValidateBeforeCall(userId, grantRequest, null, null);
        return apiClient.execute(call);
    }
    ...
    public com.squareup.okhttp.Call grantEntitlementUsingPOSTAsync(Integer userId, EntitlementGrantRequest grantRequest, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = grantEntitlementUsingPOSTValidateBeforeCall(userId, grantRequest, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
