...
public class UsersInventoryApi {
    ...
    public ApiResponse<InvoiceResource> addItemUsingPOST1WithHttpInfo(Integer id, UserInventoryAddRequest userInventoryAddRequest) throws ApiException {
        com.squareup.okhttp.Call call = addItemUsingPOST1Call(id, userInventoryAddRequest, null, null);
    ...
    public ApiResponse<EntitlementItem> createItemUsingPOSTWithHttpInfo(EntitlementItem entitlementItem) throws ApiException {
        com.squareup.okhttp.Call call = createItemUsingPOSTCall(entitlementItem, null, null);
    ...
    public ApiResponse<ItemTemplateResource> createTemplateUsingPOST3WithHttpInfo(ItemTemplateResource template) throws ApiException {
        com.squareup.okhttp.Call call = createTemplateUsingPOST3Call(template, null, null);
    ...
    public ApiResponse<Void> deleteEntitlementTemplateUsingDELETEWithHttpInfo(String id, String cascade) throws ApiException {
        com.squareup.okhttp.Call call = deleteEntitlementTemplateUsingDELETECall(id, cascade, null, null);
    ...
    public ApiResponse<Void> deleteItemUsingDELETEWithHttpInfo(Integer entitlementId) throws ApiException {
        com.squareup.okhttp.Call call = deleteItemUsingDELETECall(entitlementId, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> entitlementCheckUsingGETWithHttpInfo(String userId, Integer itemId, String sku) throws ApiException {
        com.squareup.okhttp.Call call = entitlementCheckUsingGETCall(userId, itemId, sku, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> entitlementUseUsingPOSTWithHttpInfo(String userId, Integer itemId, String sku, String info) throws ApiException {
        com.squareup.okhttp.Call call = entitlementUseUsingPOSTCall(userId, itemId, sku, info, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageEntitlementItem getCurrenciesUsingGET1(Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageEntitlementItem> resp = getCurrenciesUsingGET1WithHttpInfo(size, page, order);
        return resp.getData();
    }
     ...
     * @param page The number of the page returned, starting with 1 (optional, default to 1)
     * @param order a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)
     * @return ApiResponse&lt;PageEntitlementItem&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageEntitlementItem> getCurrenciesUsingGET1WithHttpInfo(Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getCurrenciesUsingGET1Call(size, page, order, null, null);
        Type localVarReturnType = new TypeToken<PageEntitlementItem>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCurrenciesUsingGET1Async(Integer size, Integer page, String order, final ApiCallback<PageEntitlementItem> callback) throws ApiException {
    ...
    public ApiResponse<ItemTemplateResource> getEntitlementTemplateUsingGETWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getEntitlementTemplateUsingGETCall(id, null, null);
        Type localVarReturnType = new TypeToken<ItemTemplateResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageItemTemplateResource getEntitlementTemplatesUsingGET(Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageItemTemplateResource> resp = getEntitlementTemplatesUsingGETWithHttpInfo(size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageItemTemplateResource> getEntitlementTemplatesUsingGETWithHttpInfo(Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getEntitlementTemplatesUsingGETCall(size, page, order, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getEntitlementTemplatesUsingGETAsync(Integer size, Integer page, String order, final ApiCallback<PageItemTemplateResource> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageUserInventoryResource getInventoryListUsingGET(Boolean inactive, Integer size, Integer page, String filterItemName, String filterUsername, String filterGroup, String filterDate) throws ApiException {
        ApiResponse<PageUserInventoryResource> resp = getInventoryListUsingGETWithHttpInfo(inactive, size, page, filterItemName, filterUsername, filterGroup, filterDate);
        return resp.getData();
    }
     ...
     * @param filterGroup Filter by entries owned by the users in a given group, by unique name (optional)
     * @param filterDate A comma separated string without spaces.  First value is the operator to search on, second value is the log start date, a unix timestamp in seconds. Can be repeated for a range, eg: GT,123,LT,456  Allowed operators: (GT, LT, EQ, GOE, LOE). (optional)
     * @return ApiResponse&lt;PageUserInventoryResource&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageUserInventoryResource> getInventoryListUsingGETWithHttpInfo(Boolean inactive, Integer size, Integer page, String filterItemName, String filterUsername, String filterGroup, String filterDate) throws ApiException {
        com.squareup.okhttp.Call call = getInventoryListUsingGETCall(inactive, size, page, filterItemName, filterUsername, filterGroup, filterDate, null, null);
        Type localVarReturnType = new TypeToken<PageUserInventoryResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getInventoryListUsingGETAsync(Boolean inactive, Integer size, Integer page, String filterItemName, String filterUsername, String filterGroup, String filterDate, final ApiCallback<PageUserInventoryResource> callback) throws ApiException {
    ...
    public ApiResponse<UserInventoryResource> getInventoryUsingGETWithHttpInfo(Integer userId, Integer id) throws ApiException {
        com.squareup.okhttp.Call call = getInventoryUsingGETCall(userId, id, null, null);
    ...
    public ApiResponse<EntitlementItem> getItemUsingGETWithHttpInfo(Integer entitlementId) throws ApiException {
        com.squareup.okhttp.Call call = getItemUsingGETCall(entitlementId, null, null);
        Type localVarReturnType = new TypeToken<EntitlementItem>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageUserInventoryResource getUserInventoryListUsingGET(Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate) throws ApiException {
        ApiResponse<PageUserInventoryResource> resp = getUserInventoryListUsingGETWithHttpInfo(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageUserInventoryResource> getUserInventoryListUsingGETWithHttpInfo(Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate) throws ApiException {
        com.squareup.okhttp.Call call = getUserInventoryListUsingGETCall(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate, null, null);
        Type localVarReturnType = new TypeToken<PageUserInventoryResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUserInventoryListUsingGETAsync(Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate, final ApiCallback<PageUserInventoryResource> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageUserItemLogResource getUserInventoryLogUsingGET(String userId, Integer id, Integer size, Integer page) throws ApiException {
        ApiResponse<PageUserItemLogResource> resp = getUserInventoryLogUsingGETWithHttpInfo(userId, id, size, page);
        return resp.getData();
    }
     ...
     * @param size The number of objects returned per page (optional, default to 25)
     * @param page The number of the page returned, starting with 1 (optional, default to 1)
     * @return ApiResponse&lt;PageUserItemLogResource&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageUserItemLogResource> getUserInventoryLogUsingGETWithHttpInfo(String userId, Integer id, Integer size, Integer page) throws ApiException {
        com.squareup.okhttp.Call call = getUserInventoryLogUsingGETCall(userId, id, size, page, null, null);
        Type localVarReturnType = new TypeToken<PageUserItemLogResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUserInventoryLogUsingGETAsync(String userId, Integer id, Integer size, Integer page, final ApiCallback<PageUserItemLogResource> callback) throws ApiException {
    ...
    /* Build call for grantEntitlementUsingPOST */
    private com.squareup.okhttp.Call grantEntitlementUsingPOSTCall(Integer userId, EntitlementGrantRequest grantRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = grantRequest;
        
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling grantEntitlementUsingPOST(Async)");
        }
        
        // verify the required parameter 'grantRequest' is set
        if (grantRequest == null) {
            throw new ApiException("Missing the required parameter 'grantRequest' when calling grantEntitlementUsingPOST(Async)");
        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void grantEntitlementUsingPOST(Integer userId, EntitlementGrantRequest grantRequest) throws ApiException {
        grantEntitlementUsingPOSTWithHttpInfo(userId, grantRequest);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> grantEntitlementUsingPOSTWithHttpInfo(Integer userId, EntitlementGrantRequest grantRequest) throws ApiException {
        com.squareup.okhttp.Call call = grantEntitlementUsingPOSTCall(userId, grantRequest, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call grantEntitlementUsingPOSTAsync(Integer userId, EntitlementGrantRequest grantRequest, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = grantEntitlementUsingPOSTCall(userId, grantRequest, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    ...
    public ApiResponse<Void> updateItemUsingPUT1WithHttpInfo(Integer entitlementId, EntitlementItem entitlementItem) throws ApiException {
        com.squareup.okhttp.Call call = updateItemUsingPUT1Call(entitlementId, entitlementItem, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> updateTemplateUsingPUT3WithHttpInfo(String id, ItemTemplateResource template) throws ApiException {
        com.squareup.okhttp.Call call = updateTemplateUsingPUT3Call(id, template, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> updateUserInventoryBehaviorDataUsingPUTWithHttpInfo(Integer userId, Integer id, Object data) throws ApiException {
        com.squareup.okhttp.Call call = updateUserInventoryBehaviorDataUsingPUTCall(userId, id, data, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> updateUserInventoryExpiresUsingPUTWithHttpInfo(Integer userId, Integer id, Long timestamp) throws ApiException {
        com.squareup.okhttp.Call call = updateUserInventoryExpiresUsingPUTCall(userId, id, timestamp, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> updateUserInventoryStatusUsingPUTWithHttpInfo(Integer userId, Integer id, String inventoryStatus) throws ApiException {
        com.squareup.okhttp.Call call = updateUserInventoryStatusUsingPUTCall(userId, id, inventoryStatus, null, null);
        return apiClient.execute(call);
    }
