...
public class UsersInventoryApi {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getUserInventoriesValidateBeforeCall(Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getUserInventoriesCall(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageResourceUserInventoryResource getUserInventories(Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate) throws ApiException {
        ApiResponse<PageResourceUserInventoryResource> resp = getUserInventoriesWithHttpInfo(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceUserInventoryResource> getUserInventoriesWithHttpInfo(Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate) throws ApiException {
        com.squareup.okhttp.Call call = getUserInventoriesValidateBeforeCall(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUserInventoriesAsync(Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate, final ApiCallback<PageResourceUserInventoryResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getUserInventoriesValidateBeforeCall(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageResourceUserInventoryResource>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
