...
public class AWSS3Api {
    ...
    public AWSS3Api(ApiClient apiClient) {
    ...
    private com.squareup.okhttp.Call preSignUrlUsingGETValidateBeforeCall(String filename, String contentType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<AmazonS3Activity> preSignUrlUsingGETWithHttpInfo(String filename, String contentType) throws ApiException {
        com.squareup.okhttp.Call call = preSignUrlUsingGETValidateBeforeCall(filename, contentType, null, null);
    ...
    public com.squareup.okhttp.Call preSignUrlUsingGETAsync(String filename, String contentType, final ApiCallback<AmazonS3Activity> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = preSignUrlUsingGETValidateBeforeCall(filename, contentType, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AmazonS3Activity>(){}.getType();
