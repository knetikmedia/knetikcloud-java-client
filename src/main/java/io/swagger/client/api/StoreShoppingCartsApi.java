...
public class StoreShoppingCartsApi {
    ...
    public ApiResponse<Void> addDiscountUsingPOSTWithHttpInfo(String id, SkuRequest skuRequest) throws ApiException {
        com.squareup.okhttp.Call call = addDiscountUsingPOSTCall(id, skuRequest, null, null);
    ...
    public ApiResponse<Void> addItemUsingPOSTWithHttpInfo(String id, CartItemRequest cartItemRequest) throws ApiException {
        com.squareup.okhttp.Call call = addItemUsingPOSTCall(id, cartItemRequest, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> assignCartUsingPUTWithHttpInfo(String id, Integer userId) throws ApiException {
        com.squareup.okhttp.Call call = assignCartUsingPUTCall(id, userId, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<CartShippableResponse> checkShippableUsingGETWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = checkShippableUsingGETCall(id, null, null);
    ...
    public ApiResponse<String> createCartUsingPOSTWithHttpInfo(Integer owner, String currencyCode) throws ApiException {
        com.squareup.okhttp.Call call = createCartUsingPOSTCall(owner, currencyCode, null, null);
    ...
    public ApiResponse<Cart> getCartUsingGETWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getCartUsingGETCall(id, null, null);
    ...
    public ApiResponse<SampleCountriesResponse> getCountriesUsingGETWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getCountriesUsingGETCall(id, null, null);
    ...
    public ApiResponse<Void> modifyShippingAddressUsingPUTWithHttpInfo(String id, CartShippingAddressRequest cartShippingAddressRequest) throws ApiException {
        com.squareup.okhttp.Call call = modifyShippingAddressUsingPUTCall(id, cartShippingAddressRequest, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> removeDiscountUsingDELETEWithHttpInfo(String id, String code) throws ApiException {
        com.squareup.okhttp.Call call = removeDiscountUsingDELETECall(id, code, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageResourceCartSummary searchCartsUsingGET(Integer filterOwnerId, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageResourceCartSummary> resp = searchCartsUsingGETWithHttpInfo(filterOwnerId, size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceCartSummary> searchCartsUsingGETWithHttpInfo(Integer filterOwnerId, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = searchCartsUsingGETCall(filterOwnerId, size, page, order, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchCartsUsingGETAsync(Integer filterOwnerId, Integer size, Integer page, String order, final ApiCallback<PageResourceCartSummary> callback) throws ApiException {
    ...
    public ApiResponse<Void> setCartCurrencyUsingPUTWithHttpInfo(String id, String currencyCode) throws ApiException {
        com.squareup.okhttp.Call call = setCartCurrencyUsingPUTCall(id, currencyCode, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> updateItemUsingPUTWithHttpInfo(String id, CartItemRequest cartItemRequest) throws ApiException {
        com.squareup.okhttp.Call call = updateItemUsingPUTCall(id, cartItemRequest, null, null);
        return apiClient.execute(call);
    }
