...
public class StoreShoppingCartsApi {
    ...
    private com.squareup.okhttp.Call getCountriesCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getCountriesValidateBeforeCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getCountries(Async)");
        }
        
        
        com.squareup.okhttp.Call call = getCountriesCall(id, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public SampleCountriesResponse getCountries(String id) throws ApiException {
        ApiResponse<SampleCountriesResponse> resp = getCountriesWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<SampleCountriesResponse> getCountriesWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getCountriesValidateBeforeCall(id, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCountriesAsync(String id, final ApiCallback<SampleCountriesResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCountriesValidateBeforeCall(id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<SampleCountriesResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
