...
public class ConfigsApi {
    ...
    private com.squareup.okhttp.Call createConfigUsingPOSTValidateBeforeCall(Config config, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Config> createConfigUsingPOSTWithHttpInfo(Config config) throws ApiException {
        com.squareup.okhttp.Call call = createConfigUsingPOSTValidateBeforeCall(config, null, null);
    ...
    public com.squareup.okhttp.Call createConfigUsingPOSTAsync(Config config, final ApiCallback<Config> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createConfigUsingPOSTValidateBeforeCall(config, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Config>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteConfigUsingDELETEValidateBeforeCall(String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> deleteConfigUsingDELETEWithHttpInfo(String name) throws ApiException {
        com.squareup.okhttp.Call call = deleteConfigUsingDELETEValidateBeforeCall(name, null, null);
    ...
    public com.squareup.okhttp.Call deleteConfigUsingDELETEAsync(String name, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteConfigUsingDELETEValidateBeforeCall(name, progressListener, progressRequestListener);
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getConfigUsingGETValidateBeforeCall(String name, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Config> getConfigUsingGETWithHttpInfo(String name) throws ApiException {
        com.squareup.okhttp.Call call = getConfigUsingGETValidateBeforeCall(name, null, null);
        Type localVarReturnType = new TypeToken<Config>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call getConfigUsingGETAsync(String name, final ApiCallback<Config> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getConfigUsingGETValidateBeforeCall(name, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Config>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getConfigsUsingGETValidateBeforeCall(String filterSearch, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageResourceConfig getConfigsUsingGET(String filterSearch, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageResourceConfig> resp = getConfigsUsingGETWithHttpInfo(filterSearch, size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceConfig> getConfigsUsingGETWithHttpInfo(String filterSearch, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getConfigsUsingGETValidateBeforeCall(filterSearch, size, page, order, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getConfigsUsingGETAsync(String filterSearch, Integer size, Integer page, String order, final ApiCallback<PageResourceConfig> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getConfigsUsingGETValidateBeforeCall(filterSearch, size, page, order, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageResourceConfig>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateConfigUsingPUTValidateBeforeCall(String name, Config config, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> updateConfigUsingPUTWithHttpInfo(String name, Config config) throws ApiException {
        com.squareup.okhttp.Call call = updateConfigUsingPUTValidateBeforeCall(name, config, null, null);
        return apiClient.execute(call);
    }
    ...
    public com.squareup.okhttp.Call updateConfigUsingPUTAsync(String name, Config config, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateConfigUsingPUTValidateBeforeCall(name, config, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
