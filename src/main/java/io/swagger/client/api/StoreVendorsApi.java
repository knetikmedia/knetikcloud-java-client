...
public class StoreVendorsApi {
    ...
    public ApiResponse<VendorResource> createVendorUsingPOSTWithHttpInfo(VendorResource vendor) throws ApiException {
        com.squareup.okhttp.Call call = createVendorUsingPOSTCall(vendor, null, null);
    ...
    public ApiResponse<Void> deleteVendorUsingDELETEWithHttpInfo(Integer id) throws ApiException {
        com.squareup.okhttp.Call call = deleteVendorUsingDELETECall(id, null, null);
    ...
    public ApiResponse<VendorResource> getVendorUsingGETWithHttpInfo(Integer id) throws ApiException {
        com.squareup.okhttp.Call call = getVendorUsingGETCall(id, null, null);
        Type localVarReturnType = new TypeToken<VendorResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageVendorResource getVendorsUsingGET(String filterName, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageVendorResource> resp = getVendorsUsingGETWithHttpInfo(filterName, size, page, order);
        return resp.getData();
    }
     ...
     * @param page The number of the page returned, starting with 1 (optional, default to 1)
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)
     * @return ApiResponse&lt;PageVendorResource&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageVendorResource> getVendorsUsingGETWithHttpInfo(String filterName, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getVendorsUsingGETCall(filterName, size, page, order, null, null);
        Type localVarReturnType = new TypeToken<PageVendorResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getVendorsUsingGETAsync(String filterName, Integer size, Integer page, String order, final ApiCallback<PageVendorResource> callback) throws ApiException {
    ...
    public ApiResponse<Void> updateVendorUsingPUTWithHttpInfo(Integer id, VendorResource vendor) throws ApiException {
        com.squareup.okhttp.Call call = updateVendorUsingPUTCall(id, vendor, null, null);
        return apiClient.execute(call);
    }
