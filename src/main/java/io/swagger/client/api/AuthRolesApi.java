...
public class AuthRolesApi {
    ...
    public ApiResponse<Void> assignClientRolesUsingPUTWithHttpInfo(String clientKey, List<String> rolesList) throws ApiException {
        com.squareup.okhttp.Call call = assignClientRolesUsingPUTCall(clientKey, rolesList, null, null);
    ...
    public ApiResponse<Void> assignPermissionsUsingPUTWithHttpInfo(String role, List<String> permissionsList) throws ApiException {
        com.squareup.okhttp.Call call = assignPermissionsUsingPUTCall(role, permissionsList, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> assignUserRolesExternalUsingPUTWithHttpInfo(Integer userId, List<String> rolesList) throws ApiException {
        com.squareup.okhttp.Call call = assignUserRolesExternalUsingPUTCall(userId, rolesList, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<RoleResource> createRoleUsingPOSTWithHttpInfo(RoleResource roleResource) throws ApiException {
        com.squareup.okhttp.Call call = createRoleUsingPOSTCall(roleResource, null, null);
    ...
    public ApiResponse<Void> deleteRoleUsingDELETEWithHttpInfo(String role, Boolean force) throws ApiException {
        com.squareup.okhttp.Call call = deleteRoleUsingDELETECall(role, force, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<List<RoleResource>> getClientRolesUsingGETWithHttpInfo(String clientKey) throws ApiException {
        com.squareup.okhttp.Call call = getClientRolesUsingGETCall(clientKey, null, null);
    ...
    public ApiResponse<RoleResource> getRoleUsingGETWithHttpInfo(String role) throws ApiException {
        com.squareup.okhttp.Call call = getRoleUsingGETCall(role, null, null);
        Type localVarReturnType = new TypeToken<RoleResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageRoleResource getRolesUsingGET(Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageRoleResource> resp = getRolesUsingGETWithHttpInfo(size, page, order);
        return resp.getData();
    }
     ...
     * @param page The number of the page returned, starting with 1 (optional, default to 1)
     * @param order a comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)
     * @return ApiResponse&lt;PageRoleResource&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageRoleResource> getRolesUsingGETWithHttpInfo(Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getRolesUsingGETCall(size, page, order, null, null);
        Type localVarReturnType = new TypeToken<PageRoleResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getRolesUsingGETAsync(Integer size, Integer page, String order, final ApiCallback<PageRoleResource> callback) throws ApiException {
    ...
    public ApiResponse<List<RoleResource>> getUserRolesUsingGETWithHttpInfo(Integer userId) throws ApiException {
        com.squareup.okhttp.Call call = getUserRolesUsingGETCall(userId, null, null);
        Type localVarReturnType = new TypeToken<List<RoleResource>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public ApiResponse<Void> updateRoleUsingPUTWithHttpInfo(String role, RoleResource roleResource) throws ApiException {
        com.squareup.okhttp.Call call = updateRoleUsingPUTCall(role, roleResource, null, null);
        return apiClient.execute(call);
    }
