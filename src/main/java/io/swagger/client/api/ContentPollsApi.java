...
public class ContentPollsApi {
    ...
    public ApiResponse<PollResponseResource> answerPollUsingPOSTWithHttpInfo(String id, String answerKey) throws ApiException {
        com.squareup.okhttp.Call call = answerPollUsingPOSTCall(id, answerKey, null, null);
    ...
    public ApiResponse<TemplateResource> createPollTemplateUsingPOSTWithHttpInfo(TemplateResource pollTemplateResource) throws ApiException {
        com.squareup.okhttp.Call call = createPollTemplateUsingPOSTCall(pollTemplateResource, null, null);
    ...
    public ApiResponse<PollResource> createPollUsingPOSTWithHttpInfo(PollResource pollResource) throws ApiException {
        com.squareup.okhttp.Call call = createPollUsingPOSTCall(pollResource, null, null);
    ...
    public ApiResponse<Void> deletePollTemplateUsingDELETEWithHttpInfo(String id, String cascade) throws ApiException {
        com.squareup.okhttp.Call call = deletePollTemplateUsingDELETECall(id, cascade, null, null);
    ...
    public ApiResponse<Void> deletePollUsingDELETEWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = deletePollUsingDELETECall(id, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<PollResponseResource> getPollAnswerUsingGETWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getPollAnswerUsingGETCall(id, null, null);
        Type localVarReturnType = new TypeToken<PollResponseResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public ApiResponse<TemplateResource> getPollTemplateUsingGETWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getPollTemplateUsingGETCall(id, null, null);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageTemplateResource getPollTemplatesUsingGET(Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageTemplateResource> resp = getPollTemplatesUsingGETWithHttpInfo(size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageTemplateResource> getPollTemplatesUsingGETWithHttpInfo(Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getPollTemplatesUsingGETCall(size, page, order, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPollTemplatesUsingGETAsync(Integer size, Integer page, String order, final ApiCallback<PageTemplateResource> callback) throws ApiException {
    ...
    public ApiResponse<PollResource> getPollUsingGETWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getPollUsingGETCall(id, null, null);
        Type localVarReturnType = new TypeToken<PollResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PagePollResource getPollsUsingGET(String filterCategory, String filterTagset, String filterText, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PagePollResource> resp = getPollsUsingGETWithHttpInfo(filterCategory, filterTagset, filterText, size, page, order);
        return resp.getData();
    }
     ...
     * @param page The number of the page returned (optional, default to 1)
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)
     * @return ApiResponse&lt;PagePollResource&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PagePollResource> getPollsUsingGETWithHttpInfo(String filterCategory, String filterTagset, String filterText, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getPollsUsingGETCall(filterCategory, filterTagset, filterText, size, page, order, null, null);
        Type localVarReturnType = new TypeToken<PagePollResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPollsUsingGETAsync(String filterCategory, String filterTagset, String filterText, Integer size, Integer page, String order, final ApiCallback<PagePollResource> callback) throws ApiException {
    ...
    public ApiResponse<Void> updatePollTemplateUsingPUTWithHttpInfo(String id, TemplateResource pollTemplateResource) throws ApiException {
        com.squareup.okhttp.Call call = updatePollTemplateUsingPUTCall(id, pollTemplateResource, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> updatePollUsingPUTWithHttpInfo(String id, PollResource pollResource) throws ApiException {
        com.squareup.okhttp.Call call = updatePollUsingPUTCall(id, pollResource, null, null);
        return apiClient.execute(call);
    }
