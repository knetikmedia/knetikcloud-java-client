...
public class GamificationTriviaApi {
    ...
    /* Build call for getQuestionTags1 */
    private com.squareup.okhttp.Call getQuestionTags1Call(String filterSearch, String filterCategory, Long filterImportId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getQuestionTags1ValidateBeforeCall(String filterSearch, String filterCategory, Long filterImportId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        
        com.squareup.okhttp.Call call = getQuestionTags1Call(filterSearch, filterCategory, filterImportId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Collectionstring getQuestionTags1(String filterSearch, String filterCategory, Long filterImportId) throws ApiException {
        ApiResponse<Collectionstring> resp = getQuestionTags1WithHttpInfo(filterSearch, filterCategory, filterImportId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Collectionstring> getQuestionTags1WithHttpInfo(String filterSearch, String filterCategory, Long filterImportId) throws ApiException {
        com.squareup.okhttp.Call call = getQuestionTags1ValidateBeforeCall(filterSearch, filterCategory, filterImportId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getQuestionTags1Async(String filterSearch, String filterCategory, Long filterImportId, final ApiCallback<Collectionstring> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getQuestionTags1ValidateBeforeCall(filterSearch, filterCategory, filterImportId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Collectionstring>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    private com.squareup.okhttp.Call getQuestionsValidateBeforeCall(Integer size, Integer page, String order, String filterSearch, String filterIdset, String filterCategory, String filterTagset, String filterType, Boolean filterPublished, Long filterImportId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getQuestionsCall(size, page, order, filterSearch, filterIdset, filterCategory, filterTagset, filterType, filterPublished, filterImportId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageResourceQuestionResource getQuestions(Integer size, Integer page, String order, String filterSearch, String filterIdset, String filterCategory, String filterTagset, String filterType, Boolean filterPublished, Long filterImportId) throws ApiException {
        ApiResponse<PageResourceQuestionResource> resp = getQuestionsWithHttpInfo(size, page, order, filterSearch, filterIdset, filterCategory, filterTagset, filterType, filterPublished, filterImportId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceQuestionResource> getQuestionsWithHttpInfo(Integer size, Integer page, String order, String filterSearch, String filterIdset, String filterCategory, String filterTagset, String filterType, Boolean filterPublished, Long filterImportId) throws ApiException {
        com.squareup.okhttp.Call call = getQuestionsValidateBeforeCall(size, page, order, filterSearch, filterIdset, filterCategory, filterTagset, filterType, filterPublished, filterImportId, null, null);
    ...
    public com.squareup.okhttp.Call getQuestionsAsync(Integer size, Integer page, String order, String filterSearch, String filterIdset, String filterCategory, String filterTagset, String filterType, Boolean filterPublished, Long filterImportId, final ApiCallback<PageResourceQuestionResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getQuestionsValidateBeforeCall(size, page, order, filterSearch, filterIdset, filterCategory, filterTagset, filterType, filterPublished, filterImportId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageResourceQuestionResource>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updateQuestionTemplate(String id, QuestionTemplateResource questionTemplateResource) throws ApiException {
        updateQuestionTemplateWithHttpInfo(id, questionTemplateResource);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateQuestionTemplateWithHttpInfo(String id, QuestionTemplateResource questionTemplateResource) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateQuestionTemplateAsync(String id, QuestionTemplateResource questionTemplateResource, final ApiCallback<Void> callback) throws ApiException {
