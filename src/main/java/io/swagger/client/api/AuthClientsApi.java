...
public class AuthClientsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updateClient(String clientKey, ClientResource clientResource) throws ApiException {
        updateClientWithHttpInfo(clientKey, clientResource);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateClientWithHttpInfo(String clientKey, ClientResource clientResource) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateClientAsync(String clientKey, ClientResource clientResource, final ApiCallback<Void> callback) throws ApiException {
