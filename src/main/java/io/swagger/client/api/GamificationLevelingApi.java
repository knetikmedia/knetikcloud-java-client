...
public class GamificationLevelingApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updateLevel(String name, LevelingResource newLevel) throws ApiException {
        updateLevelWithHttpInfo(name, newLevel);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateLevelWithHttpInfo(String name, LevelingResource newLevel) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateLevelAsync(String name, LevelingResource newLevel, final ApiCallback<Void> callback) throws ApiException {
    ...
    /* Build call for updateUserLevel */
    private com.squareup.okhttp.Call updateUserLevelCall(Integer userId, String name, Integer progress, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateUserLevelValidateBeforeCall(Integer userId, String name, Integer progress, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling updateUserLevel(Async)");
        }
        
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling updateUserLevel(Async)");
        }
        
        
        com.squareup.okhttp.Call call = updateUserLevelCall(userId, name, progress, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updateUserLevel(Integer userId, String name, Integer progress) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateUserLevelWithHttpInfo(Integer userId, String name, Integer progress) throws ApiException {
        com.squareup.okhttp.Call call = updateUserLevelValidateBeforeCall(userId, name, progress, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateUserLevelAsync(Integer userId, String name, Integer progress, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateUserLevelValidateBeforeCall(userId, name, progress, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
