...
public class GamificationLevelingApi {
    ...
    public ApiResponse<Void> changeUserLevelExperienceUsingPUTWithHttpInfo(Integer userId, String name, Integer progress) throws ApiException {
        com.squareup.okhttp.Call call = changeUserLevelExperienceUsingPUTCall(userId, name, progress, null, null);
    ...
    public ApiResponse<LevelingResource> createLevelUsingPOSTWithHttpInfo(LevelingResource level) throws ApiException {
        com.squareup.okhttp.Call call = createLevelUsingPOSTCall(level, null, null);
    ...
    public ApiResponse<Void> deleteLevelUsingDELETEWithHttpInfo(String name) throws ApiException {
        com.squareup.okhttp.Call call = deleteLevelUsingDELETECall(name, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<List<BreTriggerResource>> getAvailableTriggersUsingGET1WithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getAvailableTriggersUsingGET1Call(null, null);
    ...
    public ApiResponse<LevelingResource> getLevelUsingGETWithHttpInfo(String name) throws ApiException {
        com.squareup.okhttp.Call call = getLevelUsingGETCall(name, null, null);
        Type localVarReturnType = new TypeToken<LevelingResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageLevelingResource getLevelsUsingGET(String filterName, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageLevelingResource> resp = getLevelsUsingGETWithHttpInfo(filterName, size, page, order);
        return resp.getData();
    }
     ...
     * @param page The number of the page returned, starting with 1 (optional, default to 1)
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)
     * @return ApiResponse&lt;PageLevelingResource&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageLevelingResource> getLevelsUsingGETWithHttpInfo(String filterName, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getLevelsUsingGETCall(filterName, size, page, order, null, null);
        Type localVarReturnType = new TypeToken<PageLevelingResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getLevelsUsingGETAsync(String filterName, Integer size, Integer page, String order, final ApiCallback<PageLevelingResource> callback) throws ApiException {
    ...
    public ApiResponse<UserLevelingResource> getUserLevelUsingGETWithHttpInfo(Integer userId, String name) throws ApiException {
        com.squareup.okhttp.Call call = getUserLevelUsingGETCall(userId, name, null, null);
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageUserLevelingResource getUserLevelsUsingGET(Integer userId) throws ApiException {
        ApiResponse<PageUserLevelingResource> resp = getUserLevelsUsingGETWithHttpInfo(userId);
        return resp.getData();
    }
     ...
     * 
     * @param userId The id of the user (required)
     * @return ApiResponse&lt;PageUserLevelingResource&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageUserLevelingResource> getUserLevelsUsingGETWithHttpInfo(Integer userId) throws ApiException {
        com.squareup.okhttp.Call call = getUserLevelsUsingGETCall(userId, null, null);
        Type localVarReturnType = new TypeToken<PageUserLevelingResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUserLevelsUsingGETAsync(Integer userId, final ApiCallback<PageUserLevelingResource> callback) throws ApiException {
    ...
    public ApiResponse<Void> updateLevelUsingPUTWithHttpInfo(String name, LevelingResource newLevel) throws ApiException {
        com.squareup.okhttp.Call call = updateLevelUsingPUTCall(name, newLevel, null, null);
        return apiClient.execute(call);
    }
