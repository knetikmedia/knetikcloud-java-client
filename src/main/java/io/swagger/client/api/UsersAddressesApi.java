...
public class UsersAddressesApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageResourceSavedAddressResource getAddressesUsingGET(String userId, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageResourceSavedAddressResource> resp = getAddressesUsingGETWithHttpInfo(userId, size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceSavedAddressResource> getAddressesUsingGETWithHttpInfo(String userId, Integer size, Integer page, String order) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAddressesUsingGETAsync(String userId, Integer size, Integer page, String order, final ApiCallback<PageResourceSavedAddressResource> callback) throws ApiException {
