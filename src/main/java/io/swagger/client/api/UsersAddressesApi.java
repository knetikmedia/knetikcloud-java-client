...
public class UsersAddressesApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updateAddress(String userId, Integer id, SavedAddressResource savedAddressResource) throws ApiException {
        updateAddressWithHttpInfo(userId, id, savedAddressResource);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateAddressWithHttpInfo(String userId, Integer id, SavedAddressResource savedAddressResource) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateAddressAsync(String userId, Integer id, SavedAddressResource savedAddressResource, final ApiCallback<Void> callback) throws ApiException {
