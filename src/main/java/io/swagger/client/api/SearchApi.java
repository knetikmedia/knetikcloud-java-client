...
public class SearchApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageMapstringobject searchUsingPOST(String type, Object query, Integer size, Integer page) throws ApiException {
        ApiResponse<PageMapstringobject> resp = searchUsingPOSTWithHttpInfo(type, query, size, page);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageMapstringobject> searchUsingPOSTWithHttpInfo(String type, Object query, Integer size, Integer page) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchUsingPOSTAsync(String type, Object query, Integer size, Integer page, final ApiCallback<PageMapstringobject> callback) throws ApiException {
