...
public class AuthPermissionsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updatePermission(String permission, PermissionResource permissionResource) throws ApiException {
        updatePermissionWithHttpInfo(permission, permissionResource);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updatePermissionWithHttpInfo(String permission, PermissionResource permissionResource) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updatePermissionAsync(String permission, PermissionResource permissionResource, final ApiCallback<Void> callback) throws ApiException {
