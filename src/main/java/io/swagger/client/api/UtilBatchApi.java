...
public class UtilBatchApi {
     ...
     */
    public void sendBatch(Batch batch) throws ApiException {
        sendBatchWithHttpInfo(batch);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> sendBatchWithHttpInfo(Batch batch) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call sendBatchAsync(Batch batch, final ApiCallback<Void> callback) throws ApiException {
