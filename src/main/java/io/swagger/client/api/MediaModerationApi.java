...
public class MediaModerationApi {
     ...
     */
    public void getModerationReport(Long id) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> getModerationReportWithHttpInfo(Long id) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getModerationReportAsync(Long id, final ApiCallback<Void> callback) throws ApiException {
