...
public class PaymentsGoogleApi {
    ...
    private com.squareup.okhttp.Call handlePaymentUsingPOSTValidateBeforeCall(GooglePaymentRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Integer> handlePaymentUsingPOSTWithHttpInfo(GooglePaymentRequest request) throws ApiException {
        com.squareup.okhttp.Call call = handlePaymentUsingPOSTValidateBeforeCall(request, null, null);
    ...
    public com.squareup.okhttp.Call handlePaymentUsingPOSTAsync(GooglePaymentRequest request, final ApiCallback<Integer> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = handlePaymentUsingPOSTValidateBeforeCall(request, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Integer>(){}.getType();
