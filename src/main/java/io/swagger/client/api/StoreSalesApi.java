...
public class StoreSalesApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updateCatalogSale(Integer id, CatalogSale catalogSale) throws ApiException {
        updateCatalogSaleWithHttpInfo(id, catalogSale);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateCatalogSaleWithHttpInfo(Integer id, CatalogSale catalogSale) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateCatalogSaleAsync(Integer id, CatalogSale catalogSale, final ApiCallback<Void> callback) throws ApiException {
