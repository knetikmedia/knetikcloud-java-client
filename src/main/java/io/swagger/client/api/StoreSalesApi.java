...
public class StoreSalesApi {
    ...
    public ApiResponse<CatalogSale> createCatalogSaleUsingPOSTWithHttpInfo(CatalogSale catalogSale) throws ApiException {
        com.squareup.okhttp.Call call = createCatalogSaleUsingPOSTCall(catalogSale, null, null);
    ...
    public ApiResponse<Void> deleteCatalogSaleUsingDELETEWithHttpInfo(Integer id) throws ApiException {
        com.squareup.okhttp.Call call = deleteCatalogSaleUsingDELETECall(id, null, null);
    ...
    public ApiResponse<CatalogSale> getCatalogSaleUsingGETWithHttpInfo(Integer id) throws ApiException {
        com.squareup.okhttp.Call call = getCatalogSaleUsingGETCall(id, null, null);
        Type localVarReturnType = new TypeToken<CatalogSale>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageResourceCatalogSale getCatalogSalesUsingGET(Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageResourceCatalogSale> resp = getCatalogSalesUsingGETWithHttpInfo(size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceCatalogSale> getCatalogSalesUsingGETWithHttpInfo(Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getCatalogSalesUsingGETCall(size, page, order, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCatalogSalesUsingGETAsync(Integer size, Integer page, String order, final ApiCallback<PageResourceCatalogSale> callback) throws ApiException {
    ...
    public ApiResponse<Void> updateCatalogSaleUsingPUTWithHttpInfo(Integer id, CatalogSale catalogSale) throws ApiException {
        com.squareup.okhttp.Call call = updateCatalogSaleUsingPUTCall(id, catalogSale, null, null);
        return apiClient.execute(call);
    }
