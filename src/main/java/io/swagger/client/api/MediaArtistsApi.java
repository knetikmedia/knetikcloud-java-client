...
public class MediaArtistsApi {
    ...
    public ApiResponse<ArtistResource> addArtistUsingPOSTWithHttpInfo(ArtistResource artistResource) throws ApiException {
        com.squareup.okhttp.Call call = addArtistUsingPOSTCall(artistResource, null, null);
    ...
    public ApiResponse<TemplateResource> createArtistTemplateUsingPOSTWithHttpInfo(TemplateResource artistTemplateResource) throws ApiException {
        com.squareup.okhttp.Call call = createArtistTemplateUsingPOSTCall(artistTemplateResource, null, null);
    ...
    public ApiResponse<Void> deleteArtistTemplateUsingDELETEWithHttpInfo(String id, String cascade) throws ApiException {
        com.squareup.okhttp.Call call = deleteArtistTemplateUsingDELETECall(id, cascade, null, null);
    ...
    public ApiResponse<Void> deleteArtistUsingDELETEWithHttpInfo(Long id) throws ApiException {
        com.squareup.okhttp.Call call = deleteArtistUsingDELETECall(id, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<TemplateResource> getArtistTemplateUsingGETWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getArtistTemplateUsingGETCall(id, null, null);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageTemplateResource getArtistTemplatesUsingGET(Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageTemplateResource> resp = getArtistTemplatesUsingGETWithHttpInfo(size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageTemplateResource> getArtistTemplatesUsingGETWithHttpInfo(Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getArtistTemplatesUsingGETCall(size, page, order, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getArtistTemplatesUsingGETAsync(Integer size, Integer page, String order, final ApiCallback<PageTemplateResource> callback) throws ApiException {
    ...
    public ApiResponse<ArtistResource> getArtistUsingGETWithHttpInfo(Long id, Integer showContributions) throws ApiException {
        com.squareup.okhttp.Call call = getArtistUsingGETCall(id, showContributions, null, null);
        Type localVarReturnType = new TypeToken<ArtistResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageArtistResource searchArtistsUsingGET(String filterArtistsByName, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageArtistResource> resp = searchArtistsUsingGETWithHttpInfo(filterArtistsByName, size, page, order);
        return resp.getData();
    }
     ...
     * @param page The number of the page returned, starting with 1 (optional, default to 1)
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)
     * @return ApiResponse&lt;PageArtistResource&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageArtistResource> searchArtistsUsingGETWithHttpInfo(String filterArtistsByName, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = searchArtistsUsingGETCall(filterArtistsByName, size, page, order, null, null);
        Type localVarReturnType = new TypeToken<PageArtistResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchArtistsUsingGETAsync(String filterArtistsByName, Integer size, Integer page, String order, final ApiCallback<PageArtistResource> callback) throws ApiException {
    ...
    public ApiResponse<Void> updateArtistTemplateUsingPUTWithHttpInfo(String id, TemplateResource artistTemplateResource) throws ApiException {
        com.squareup.okhttp.Call call = updateArtistTemplateUsingPUTCall(id, artistTemplateResource, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> updateArtistUsingPUTWithHttpInfo(Long id, ArtistResource artistResource) throws ApiException {
        com.squareup.okhttp.Call call = updateArtistUsingPUTCall(id, artistResource, null, null);
        return apiClient.execute(call);
    }
