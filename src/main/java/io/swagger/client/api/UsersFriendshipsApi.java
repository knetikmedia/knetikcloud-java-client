...
public class UsersFriendshipsApi {
    ...
    public ApiResponse<Void> addFriendUsingPOSTWithHttpInfo(String userId, Integer id) throws ApiException {
        com.squareup.okhttp.Call call = addFriendUsingPOSTCall(userId, id, null, null);
    ...
    public ApiResponse<Void> connectUsingTokenUsingPOSTWithHttpInfo(String userId, String token) throws ApiException {
        com.squareup.okhttp.Call call = connectUsingTokenUsingPOSTCall(userId, token, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageResourceSimpleUserResource getFriendsUsingGET(String userId, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageResourceSimpleUserResource> resp = getFriendsUsingGETWithHttpInfo(userId, size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceSimpleUserResource> getFriendsUsingGETWithHttpInfo(String userId, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getFriendsUsingGETCall(userId, size, page, order, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getFriendsUsingGETAsync(String userId, Integer size, Integer page, String order, final ApiCallback<PageResourceSimpleUserResource> callback) throws ApiException {
    ...
    public ApiResponse<String> getInviteTokenUsingGETWithHttpInfo(String userId) throws ApiException {
        com.squareup.okhttp.Call call = getInviteTokenUsingGETCall(userId, null, null);
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageResourceSimpleUserResource getInvitesUsingGET(String userId, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageResourceSimpleUserResource> resp = getInvitesUsingGETWithHttpInfo(userId, size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceSimpleUserResource> getInvitesUsingGETWithHttpInfo(String userId, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getInvitesUsingGETCall(userId, size, page, order, null, null);
        Type localVarReturnType = new TypeToken<PageResourceSimpleUserResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getInvitesUsingGETAsync(String userId, Integer size, Integer page, String order, final ApiCallback<PageResourceSimpleUserResource> callback) throws ApiException {
    ...
    public ApiResponse<Void> removeFriendUsingDELETEWithHttpInfo(String userId, Integer id) throws ApiException {
        com.squareup.okhttp.Call call = removeFriendUsingDELETECall(userId, id, null, null);
        return apiClient.execute(call);
    }
