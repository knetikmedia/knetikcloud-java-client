...
public class PaymentsWalletsApi {
    ...
    private com.squareup.okhttp.Call getWalletTransactionsValidateBeforeCall(Integer filterInvoice, String filterType, Long filterMaxDate, Long filterMinDate, String filterSign, Integer filterUserId, String filterUsername, String filterDetails, String filterCurrencyCode, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getWalletTransactionsCall(filterInvoice, filterType, filterMaxDate, filterMinDate, filterSign, filterUserId, filterUsername, filterDetails, filterCurrencyCode, size, page, order, progressListener, progressRequestListener);
        return call;
    ...
    public PageResourceWalletTransactionResource getWalletTransactions(Integer filterInvoice, String filterType, Long filterMaxDate, Long filterMinDate, String filterSign, Integer filterUserId, String filterUsername, String filterDetails, String filterCurrencyCode, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageResourceWalletTransactionResource> resp = getWalletTransactionsWithHttpInfo(filterInvoice, filterType, filterMaxDate, filterMinDate, filterSign, filterUserId, filterUsername, filterDetails, filterCurrencyCode, size, page, order);
        return resp.getData();
    }
    ...
    public ApiResponse<PageResourceWalletTransactionResource> getWalletTransactionsWithHttpInfo(Integer filterInvoice, String filterType, Long filterMaxDate, Long filterMinDate, String filterSign, Integer filterUserId, String filterUsername, String filterDetails, String filterCurrencyCode, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getWalletTransactionsValidateBeforeCall(filterInvoice, filterType, filterMaxDate, filterMinDate, filterSign, filterUserId, filterUsername, filterDetails, filterCurrencyCode, size, page, order, null, null);
        Type localVarReturnType = new TypeToken<PageResourceWalletTransactionResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call getWalletTransactionsAsync(Integer filterInvoice, String filterType, Long filterMaxDate, Long filterMinDate, String filterSign, Integer filterUserId, String filterUsername, String filterDetails, String filterCurrencyCode, Integer size, Integer page, String order, final ApiCallback<PageResourceWalletTransactionResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getWalletTransactionsValidateBeforeCall(filterInvoice, filterType, filterMaxDate, filterMinDate, filterSign, filterUserId, filterUsername, filterDetails, filterCurrencyCode, size, page, order, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageResourceWalletTransactionResource>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
