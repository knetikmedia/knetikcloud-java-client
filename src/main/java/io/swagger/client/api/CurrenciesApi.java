...
public class CurrenciesApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageResourceCurrencyResource getCurrenciesUsingGET(Boolean filterEnabledCurrencies, String filterType, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageResourceCurrencyResource> resp = getCurrenciesUsingGETWithHttpInfo(filterEnabledCurrencies, filterType, size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceCurrencyResource> getCurrenciesUsingGETWithHttpInfo(Boolean filterEnabledCurrencies, String filterType, Integer size, Integer page, String order) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getCurrenciesUsingGETAsync(Boolean filterEnabledCurrencies, String filterType, Integer size, Integer page, String order, final ApiCallback<PageResourceCurrencyResource> callback) throws ApiException {
