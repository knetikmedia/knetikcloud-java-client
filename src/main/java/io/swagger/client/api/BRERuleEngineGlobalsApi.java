...
public class BRERuleEngineGlobalsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updateBREGlobal(String id, BreGlobalResource breGlobalResource) throws ApiException {
        updateBREGlobalWithHttpInfo(id, breGlobalResource);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateBREGlobalWithHttpInfo(String id, BreGlobalResource breGlobalResource) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateBREGlobalAsync(String id, BreGlobalResource breGlobalResource, final ApiCallback<Void> callback) throws ApiException {
