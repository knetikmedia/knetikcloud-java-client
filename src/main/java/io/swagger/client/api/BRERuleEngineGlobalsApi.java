...
public class BRERuleEngineGlobalsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageBreGlobalResource getGlobalsUsingGET(Boolean filterSystem, Integer size, Integer page) throws ApiException {
        ApiResponse<PageBreGlobalResource> resp = getGlobalsUsingGETWithHttpInfo(filterSystem, size, page);
        return resp.getData();
    }
     ...
     * @param size The number of objects returned per page (optional, default to 25)
     * @param page The number of the page returned, starting with 1 (optional, default to 1)
     * @return ApiResponse&lt;PageBreGlobalResource&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageBreGlobalResource> getGlobalsUsingGETWithHttpInfo(Boolean filterSystem, Integer size, Integer page) throws ApiException {
        com.squareup.okhttp.Call call = getGlobalsUsingGETCall(filterSystem, size, page, null, null);
        Type localVarReturnType = new TypeToken<PageBreGlobalResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getGlobalsUsingGETAsync(Boolean filterSystem, Integer size, Integer page, final ApiCallback<PageBreGlobalResource> callback) throws ApiException {
