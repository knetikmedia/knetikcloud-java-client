...
public class ContentArticlesApi {
    ...
    public ApiResponse<TemplateResource> createArticleTemplateUsingPOSTWithHttpInfo(TemplateResource articleTemplateResource) throws ApiException {
        com.squareup.okhttp.Call call = createArticleTemplateUsingPOSTCall(articleTemplateResource, null, null);
    ...
    public ApiResponse<ArticleResource> createArticleUsingPOSTWithHttpInfo(ArticleResource articleResource) throws ApiException {
        com.squareup.okhttp.Call call = createArticleUsingPOSTCall(articleResource, null, null);
    ...
    public ApiResponse<Void> deleteArticleTemplateUsingDELETEWithHttpInfo(String id, String cascade) throws ApiException {
        com.squareup.okhttp.Call call = deleteArticleTemplateUsingDELETECall(id, cascade, null, null);
    ...
    public ApiResponse<Void> deleteArticleUsingDELETEWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = deleteArticleUsingDELETECall(id, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<TemplateResource> getArticleTemplateUsingGETWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getArticleTemplateUsingGETCall(id, null, null);
        Type localVarReturnType = new TypeToken<TemplateResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageTemplateResource getArticleTemplatesUsingGET(Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageTemplateResource> resp = getArticleTemplatesUsingGETWithHttpInfo(size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageTemplateResource> getArticleTemplatesUsingGETWithHttpInfo(Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getArticleTemplatesUsingGETCall(size, page, order, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getArticleTemplatesUsingGETAsync(Integer size, Integer page, String order, final ApiCallback<PageTemplateResource> callback) throws ApiException {
    ...
    public ApiResponse<ArticleResource> getArticleUsingGETWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getArticleUsingGETCall(id, null, null);
        Type localVarReturnType = new TypeToken<ArticleResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageArticleResource getArticlesUsingGET(String filterCategory, String filterTagset, String filterTitle, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageArticleResource> resp = getArticlesUsingGETWithHttpInfo(filterCategory, filterTagset, filterTitle, size, page, order);
        return resp.getData();
    }
     ...
     * @param page The number of the page returned, starting with 1 (optional, default to 1)
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to 1)
     * @return ApiResponse&lt;PageArticleResource&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageArticleResource> getArticlesUsingGETWithHttpInfo(String filterCategory, String filterTagset, String filterTitle, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getArticlesUsingGETCall(filterCategory, filterTagset, filterTitle, size, page, order, null, null);
        Type localVarReturnType = new TypeToken<PageArticleResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getArticlesUsingGETAsync(String filterCategory, String filterTagset, String filterTitle, Integer size, Integer page, String order, final ApiCallback<PageArticleResource> callback) throws ApiException {
    ...
    public ApiResponse<Void> updateArticleTemplateUsingPUTWithHttpInfo(String id, TemplateResource articleTemplateResource) throws ApiException {
        com.squareup.okhttp.Call call = updateArticleTemplateUsingPUTCall(id, articleTemplateResource, null, null);
        return apiClient.execute(call);
    }
    ...
    public ApiResponse<Void> updateArticleUsingPUTWithHttpInfo(String id, ArticleResource articleResource) throws ApiException {
        com.squareup.okhttp.Call call = updateArticleUsingPUTCall(id, articleResource, null, null);
        return apiClient.execute(call);
    }
