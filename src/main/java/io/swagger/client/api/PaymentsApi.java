...
public class PaymentsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updatePaymentMethod(Integer userId, Integer id, PaymentMethodResource paymentMethod) throws ApiException {
        updatePaymentMethodWithHttpInfo(userId, id, paymentMethod);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updatePaymentMethodWithHttpInfo(Integer userId, Integer id, PaymentMethodResource paymentMethod) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updatePaymentMethodAsync(Integer userId, Integer id, PaymentMethodResource paymentMethod, final ApiCallback<Void> callback) throws ApiException {
