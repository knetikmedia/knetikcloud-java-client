...
public class StoreApi {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getUsingGET2ValidateBeforeCall(Integer limit, Integer page, Boolean useCatalog, Boolean ignoreLocation, Boolean inStockOnly, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageResourceStoreItem getUsingGET2(Integer limit, Integer page, Boolean useCatalog, Boolean ignoreLocation, Boolean inStockOnly) throws ApiException {
        ApiResponse<PageResourceStoreItem> resp = getUsingGET2WithHttpInfo(limit, page, useCatalog, ignoreLocation, inStockOnly);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceStoreItem> getUsingGET2WithHttpInfo(Integer limit, Integer page, Boolean useCatalog, Boolean ignoreLocation, Boolean inStockOnly) throws ApiException {
        com.squareup.okhttp.Call call = getUsingGET2ValidateBeforeCall(limit, page, useCatalog, ignoreLocation, inStockOnly, null, null);
        Type localVarReturnType = new TypeToken<PageResourceStoreItem>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUsingGET2Async(Integer limit, Integer page, Boolean useCatalog, Boolean ignoreLocation, Boolean inStockOnly, final ApiCallback<PageResourceStoreItem> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getUsingGET2ValidateBeforeCall(limit, page, useCatalog, ignoreLocation, inStockOnly, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageResourceStoreItem>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
