...
public class StoreApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageStoreItem getUsingGET2(StoreListRequest storeListRequest) throws ApiException {
        ApiResponse<PageStoreItem> resp = getUsingGET2WithHttpInfo(storeListRequest);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageStoreItem> getUsingGET2WithHttpInfo(StoreListRequest storeListRequest) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUsingGET2Async(StoreListRequest storeListRequest, final ApiCallback<PageStoreItem> callback) throws ApiException {
