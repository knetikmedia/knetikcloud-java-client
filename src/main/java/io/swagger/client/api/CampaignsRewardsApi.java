...
public class CampaignsRewardsApi {
    ...
    private com.squareup.okhttp.Call createRewardSetUsingPOSTValidateBeforeCall(RewardSetResource rewardSetResource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<RewardSetResource> createRewardSetUsingPOSTWithHttpInfo(RewardSetResource rewardSetResource) throws ApiException {
        com.squareup.okhttp.Call call = createRewardSetUsingPOSTValidateBeforeCall(rewardSetResource, null, null);
    ...
    public com.squareup.okhttp.Call createRewardSetUsingPOSTAsync(RewardSetResource rewardSetResource, final ApiCallback<RewardSetResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createRewardSetUsingPOSTValidateBeforeCall(rewardSetResource, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RewardSetResource>(){}.getType();
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteRewardSetUsingDELETEValidateBeforeCall(Integer id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> deleteRewardSetUsingDELETEWithHttpInfo(Integer id) throws ApiException {
        com.squareup.okhttp.Call call = deleteRewardSetUsingDELETEValidateBeforeCall(id, null, null);
    ...
    public com.squareup.okhttp.Call deleteRewardSetUsingDELETEAsync(Integer id, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteRewardSetUsingDELETEValidateBeforeCall(id, progressListener, progressRequestListener);
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getRewardSetUsingGETValidateBeforeCall(Integer id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<RewardSetResource> getRewardSetUsingGETWithHttpInfo(Integer id) throws ApiException {
        com.squareup.okhttp.Call call = getRewardSetUsingGETValidateBeforeCall(id, null, null);
        Type localVarReturnType = new TypeToken<RewardSetResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    public com.squareup.okhttp.Call getRewardSetUsingGETAsync(Integer id, final ApiCallback<RewardSetResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getRewardSetUsingGETValidateBeforeCall(id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<RewardSetResource>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getRewardSetsUsingGETValidateBeforeCall(Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageRewardSetResource getRewardSetsUsingGET(Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageRewardSetResource> resp = getRewardSetsUsingGETWithHttpInfo(size, page, order);
        return resp.getData();
    }
     ...
     * @param page The number of the page returned, starting with 1 (optional, default to 1)
     * @param order A comma separated list of sorting requirements in priority order, each entry matching PROPERTY_NAME:[ASC|DESC] (optional, default to id:ASC)
     * @return ApiResponse&lt;PageRewardSetResource&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageRewardSetResource> getRewardSetsUsingGETWithHttpInfo(Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = getRewardSetsUsingGETValidateBeforeCall(size, page, order, null, null);
        Type localVarReturnType = new TypeToken<PageRewardSetResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getRewardSetsUsingGETAsync(Integer size, Integer page, String order, final ApiCallback<PageRewardSetResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getRewardSetsUsingGETValidateBeforeCall(size, page, order, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageRewardSetResource>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateRewardSetUsingPUTValidateBeforeCall(Integer id, RewardSetResource rewardSetResource, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<Void> updateRewardSetUsingPUTWithHttpInfo(Integer id, RewardSetResource rewardSetResource) throws ApiException {
        com.squareup.okhttp.Call call = updateRewardSetUsingPUTValidateBeforeCall(id, rewardSetResource, null, null);
        return apiClient.execute(call);
    }
    ...
    public com.squareup.okhttp.Call updateRewardSetUsingPUTAsync(Integer id, RewardSetResource rewardSetResource, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateRewardSetUsingPUTValidateBeforeCall(id, rewardSetResource, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
