...
public class CampaignsRewardsApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updateRewardSet(Integer id, RewardSetResource rewardSetResource) throws ApiException {
        updateRewardSetWithHttpInfo(id, rewardSetResource);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateRewardSetWithHttpInfo(Integer id, RewardSetResource rewardSetResource) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateRewardSetAsync(Integer id, RewardSetResource rewardSetResource, final ApiCallback<Void> callback) throws ApiException {
