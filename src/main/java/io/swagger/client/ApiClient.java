...
public class ApiClient {
    ...
    private String basePath = "https://integration.knetikcloud.com/";
    ...
    public ApiClient() {
        ...
        setUserAgent("Swagger-Codegen/3.0.3/java");

        // Setup authentications (key: authentication name, value: authentication).
        authentications = new HashMap<String, Authentication>();
        authentications.put("knetik_oauth", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://integration.knetikcloud.com/
