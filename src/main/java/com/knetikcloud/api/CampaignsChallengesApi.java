...
public class CampaignsChallengesApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public PageResourceChallengeResource getChallenges(Boolean filterActiveCampaign, String filterStartDate, String filterEndDate, Integer size, Integer page, String order) throws ApiException {
    Object localVarPostBody = null;
