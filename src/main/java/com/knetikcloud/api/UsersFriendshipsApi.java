...
public class UsersFriendshipsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public PageResourceSimpleUserResource getFriends(String userId, String filterUsername, Integer filterUserId, Integer size, Integer page) throws ApiException {
    Object localVarPostBody = null;
