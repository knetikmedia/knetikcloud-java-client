...
public class SearchApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public PageResourceMapstringobject searchIndexWithTemplate(String type, String template, Object query, Integer size, Integer page) throws ApiException {
    Object localVarPostBody = query;
    
    // verify the required parameter 'type' is set
    if (type == null) {
      throw new ApiException(400, "Missing the required parameter 'type' when calling searchIndexWithTemplate");
    }
    
    // verify the required parameter 'template' is set
    if (template == null) {
      throw new ApiException(400, "Missing the required parameter 'template' when calling searchIndexWithTemplate");
    }
