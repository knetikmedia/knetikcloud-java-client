...
public class UsersGroupsApi {
    ...
    private com.squareup.okhttp.Call updateGroupsCall(String filterName, String filterUniqueName, String filterParent, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateGroupsValidateBeforeCall(String filterName, String filterUniqueName, String filterParent, Integer size, Integer page, String order, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        
        com.squareup.okhttp.Call call = updateGroupsCall(filterName, filterUniqueName, filterParent, size, page, order, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PageResourceGroupResource updateGroups(String filterName, String filterUniqueName, String filterParent, Integer size, Integer page, String order) throws ApiException {
        ApiResponse<PageResourceGroupResource> resp = updateGroupsWithHttpInfo(filterName, filterUniqueName, filterParent, size, page, order);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PageResourceGroupResource> updateGroupsWithHttpInfo(String filterName, String filterUniqueName, String filterParent, Integer size, Integer page, String order) throws ApiException {
        com.squareup.okhttp.Call call = updateGroupsValidateBeforeCall(filterName, filterUniqueName, filterParent, size, page, order, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateGroupsAsync(String filterName, String filterUniqueName, String filterParent, Integer size, Integer page, String order, final ApiCallback<PageResourceGroupResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateGroupsValidateBeforeCall(filterName, filterUniqueName, filterParent, size, page, order, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PageResourceGroupResource>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
