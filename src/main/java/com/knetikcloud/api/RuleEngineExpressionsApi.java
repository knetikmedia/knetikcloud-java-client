...
public class RuleEngineExpressionsApi {
  ...
  public RuleEngineExpressionsApi() {
    this(Configuration.getDefaultApiClient());
  }

  public RuleEngineExpressionsApi(ApiClient apiClient) {
   ...
   */
  public ExpressionResource getBREExpression(String type) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'type' is set
    if (type == null) {
      throw new ApiException(400, "Missing the required parameter 'type' when calling getBREExpression");
    }
    
    // create path and map variables
    String localVarPath = "/bre/expressions/{type}"
    ...
    GenericType<ExpressionResource> localVarReturnType = new GenericType<ExpressionResource>() {};
  ...
  public List<ExpressionResource> getBREExpressions(String filterTypeGroup) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/bre/expressions";
   ...
   * @throws ApiException if fails to make API call
   */
  public StringWrapper getExpressionAsText(ExpressionResource expression) throws ApiException {
