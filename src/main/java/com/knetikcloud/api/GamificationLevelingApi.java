...
public class GamificationLevelingApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public UserLevelingResource getUserLevel(String userId, String name) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public PageResourceUserLevelingResource getUserLevels(String userId, String filterName, Integer size, Integer page, String order) throws ApiException {
    Object localVarPostBody = null;
