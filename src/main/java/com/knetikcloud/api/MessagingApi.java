...
public class MessagingApi {
   ...
   */
  public Map<String, String> compileMessageTemplate(MessageTemplateBulkRequest request) throws ApiException {
    Object localVarPostBody = request;
    
    // create path and map variables
    String localVarPath = "/messaging/templates/compilations";
   ...
   * @throws ApiException if fails to make API call
   */
  public MessageTemplateResource createMessageTemplate(MessageTemplateResource messageTemplate) throws ApiException {
    Object localVarPostBody = messageTemplate;
    
    // create path and map variables
    String localVarPath = "/messaging/templates";
    ...
    GenericType<MessageTemplateResource> localVarReturnType = new GenericType<MessageTemplateResource>() {};
    return apiClient.invokeAPI(localVarPath, "POST", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
      }
  /**
   ...
   * @throws ApiException if fails to make API call
   */
  public void deleteMessageTemplate(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling deleteMessageTemplate");
    }
    
    // create path and map variables
    String localVarPath = "/messaging/templates/{id}"
   ...
   * @throws ApiException if fails to make API call
   */
  public MessageTemplateResource getMessageTemplate(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getMessageTemplate");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public PageResourceMessageTemplateResource getMessageTemplates(String filterTagset, String filterTagIntersection, String filterTagExclusion, Integer size, Integer page, String order) throws ApiException {
    Object localVarPostBody = null;
    ...
    GenericType<PageResourceMessageTemplateResource> localVarReturnType = new GenericType<PageResourceMessageTemplateResource>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
      }
  /**
   * Send a message
  ...
  public void sendMessage(MessageResource messageResource) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/messaging/message";
   ...
   * @throws ApiException if fails to make API call
   */
  public void sendRawPush(RawPushResource rawPushResource) throws ApiException {
    Object localVarPostBody = rawPushResource;
    
    // create path and map variables
    String localVarPath = "/messaging/raw-push";
   ...
   * @throws ApiException if fails to make API call
   */
  public void sendTemplatedPush(TemplatePushResource templatePushResource) throws ApiException {
    Object localVarPostBody = templatePushResource;
    
    // create path and map variables
    String localVarPath = "/messaging/templated-push";
   ...
   * @throws ApiException if fails to make API call
   */
  public void sendWebsocket(WebsocketMessageResource websocketResource) throws ApiException {
    Object localVarPostBody = websocketResource;
    
    // create path and map variables
    String localVarPath = "/messaging/websocket-message";
   ...
   * @throws ApiException if fails to make API call
   */
  public MessageTemplateResource updateMessageTemplate(String id, MessageTemplateResource messageTemplateResource) throws ApiException {
    Object localVarPostBody = messageTemplateResource;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling updateMessageTemplate");
    }
