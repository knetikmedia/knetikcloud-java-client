...
public class ActivityOccurrenceResource {
  ...
  **/
   ...
   * @return settings
  **/
  @ApiModelProperty(example = "null", value = "The list of settings and their options available for this activity. Should be null on create if and only if part of an event. Otherwise, the set must exactly match those of the activity.")
