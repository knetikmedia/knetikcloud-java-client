...
public class CategoriesApiTest {
    ...
    public void getArticleTemplatesUsingGET1Test() throws ApiException {
        ...
        Integer page = null;
        String order = null;
        PageResourceTemplateResource response = api.getArticleTemplatesUsingGET1(size, page, order);
    ...
    public void getCategoriesUsingGET1Test() throws ApiException {
        ...
        Integer page = null;
        String order = null;
        PageResourceCategoryResource response = api.getCategoriesUsingGET1(filterSearch, filterActive, size, page, order);
    ...
    public void getTagsUsingGETTest() throws ApiException {
        Integer size = null;
        Integer page = null;
        PageResourcestring response = api.getTagsUsingGET(size, page);
