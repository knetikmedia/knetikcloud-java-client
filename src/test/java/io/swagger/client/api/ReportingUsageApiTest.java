...
public class ReportingUsageApiTest {
    ...
    public void getUsageByDayUsingGETTest() throws ApiException {
        ...
        Integer size = null;
        Integer page = null;
        PageResourceUsageInfo response = api.getUsageByDayUsingGET(startDate, endDate, combineEndpoints, size, page);
    ...
    public void getUsageByHourUsingGETTest() throws ApiException {
        ...
        Integer size = null;
        Integer page = null;
        PageResourceUsageInfo response = api.getUsageByHourUsingGET(startDate, endDate, combineEndpoints, size, page);
    ...
    public void getUsageByMinuteUsingGETTest() throws ApiException {
        ...
        Integer size = null;
        Integer page = null;
        PageResourceUsageInfo response = api.getUsageByMinuteUsingGET(startDate, endDate, combineEndpoints, size, page);
    ...
    public void getUsageByMonthUsingGETTest() throws ApiException {
        ...
        Integer size = null;
        Integer page = null;
        PageResourceUsageInfo response = api.getUsageByMonthUsingGET(startDate, endDate, combineEndpoints, size, page);
    ...
    public void getUsageByYearUsingGETTest() throws ApiException {
        ...
        Integer size = null;
        Integer page = null;
        PageResourceUsageInfo response = api.getUsageByYearUsingGET(startDate, endDate, combineEndpoints, size, page);
