...
public class UsersInventoryApiTest {
    ...
    public void getCurrenciesUsingGET1Test() throws ApiException {
        ...
        Integer page = null;
        String order = null;
        // PageEntitlementItem response = api.getCurrenciesUsingGET1(size, page, order);
    ...
    public void getEntitlementTemplatesUsingGETTest() throws ApiException {
        ...
        Integer page = null;
        String order = null;
        // PageItemTemplateResource response = api.getEntitlementTemplatesUsingGET(size, page, order);
    ...
    public void getInventoryListUsingGETTest() throws ApiException {
        ...
        // PageUserInventoryResource response = api.getInventoryListUsingGET(inactive, size, page, filterItemName, filterUsername, filterGroup, filterDate);
    ...
    public void getUserInventoryListUsingGETTest() throws ApiException {
        ...
        // PageUserInventoryResource response = api.getUserInventoryListUsingGET(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate);
    ...
    public void getUserInventoryLogUsingGETTest() throws ApiException {
        ...
        Integer size = null;
        Integer page = null;
        // PageUserItemLogResource response = api.getUserInventoryLogUsingGET(userId, id, size, page);
     ...
     */
    @Test
    public void grantEntitlementUsingPOSTTest() throws ApiException {
        Integer userId = null;
        EntitlementGrantRequest grantRequest = null;
        // api.grantEntitlementUsingPOST(userId, grantRequest);
