...
public class UsersInventoryApiTest {
    ...
    public void createEntitlementItemTest() throws ApiException {
        ...
        EntitlementItem response = api.createEntitlementItem(entitlementItem);
     ...
     */
    @Test
    public void getUserInventory1Test() throws ApiException {
        Integer id = null;
        ...
        PageResourceUserInventoryResource response = api.getUserInventory1(id, inactive, size, page, filterItemName, filterMinDate, filterMaxDate);
     ...
     */
    @Test
    public void getUserInventoryLog1Test() throws ApiException {
        Integer userId = null;
        Integer id = null;
        Long timestamp = null;
        api.getUserInventoryLog1(userId, id, timestamp);
    ...
    public void getUsersInventoryTest() throws ApiException {
        ...
        PageResourceUserInventoryResource response = api.getUsersInventory(inactive, size, page, filterItemName, filterUsername, filterGroup, filterDate);
    ...
    public void updateEntitlementItemTest() throws ApiException {
        Integer entitlementId = null;
        EntitlementItem entitlementItem = null;
        api.updateEntitlementItem(entitlementId, entitlementItem);
    ...
    public void updateEntitlementTemplateTest() throws ApiException {
        String id = null;
        ItemTemplateResource template = null;
        api.updateEntitlementTemplate(id, template);
