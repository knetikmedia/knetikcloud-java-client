...
public class UsersGroupsApiTest {
    ...
    public void getGroupTemplatesUsingGETTest() throws ApiException {
        ...
        Integer page = null;
        String order = null;
        PageResourceTemplateResource response = api.getGroupTemplatesUsingGET(size, page, order);
    ...
    public void searchGroupsUsingGETTest() throws ApiException {
        ...
        Integer page = null;
        String order = null;
        PageResourceGroupMemberResource response = api.searchGroupsUsingGET(uniqueName, size, page, order);
    ...
    public void searchGroupsUsingGET1Test() throws ApiException {
        ...
        Integer page = null;
        String order = null;
        PageResourceGroupResource response = api.searchGroupsUsingGET1(size, page, order);
