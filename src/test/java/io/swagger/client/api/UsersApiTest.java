...
public class UsersApiTest {
    ...
    public void getUsersTest() throws ApiException {
        ...
        Integer page = null;
        String order = null;
        PageResourceUserBaseResource response = api.getUsers(filterDisplayname, filterEmail, filterFirstname, filterFullname, filterLastname, filterUsername, filterTag, filterGroup, size, page, order);
    ...
    public void updateUserTemplateTest() throws ApiException {
        String id = null;
        TemplateResource userTemplateResource = null;
        api.updateUserTemplate(id, userTemplateResource);
