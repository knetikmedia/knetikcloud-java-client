...
public class UsersApiTest {
    ...
    public void getUserTemplatesUsingGETTest() throws ApiException {
        ...
        Integer page = null;
        String order = null;
        PageTemplateResource response = api.getUserTemplatesUsingGET(size, page, order);
    ...
    public void getUsersUsingGETTest() throws ApiException {
        ...
        Integer page = null;
        String order = null;
        PageUserBaseResource response = api.getUsersUsingGET(filterRole, filterDisplayname, filterEmail, filterFirstname, filterFullname, filterLastname, filterUsername, filterTag, filterGroup, size, page, order);
