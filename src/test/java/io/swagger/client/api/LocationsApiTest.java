...
public class LocationsApiTest {
    ...
    public void getCitiesTest() throws ApiException {
        ...
        List<CityResource> response = api.getCities(countryCodeIso3, stateCode);
     ...
     */
    @Test
    public void getCountries1Test() throws ApiException {
        List<CountryResource> response = api.getCountries1();
     ...
     */
    @Test
    public void getCountries2Test() throws ApiException {
        String countryCodeIso3 = null;
        List<StateResource> response = api.getCountries2(countryCodeIso3);
