...
public class GamificationTriviaApiTest {
     ...
     */
    @Test
    public void getQuestionTags1Test() throws ApiException {
        String filterSearch = null;
        String filterCategory = null;
        Long filterImportId = null;
        Collectionstring response = api.getQuestionTags1(filterSearch, filterCategory, filterImportId);
    ...
    public void getQuestionsTest() throws ApiException {
        ...
        Boolean filterPublished = null;
        Long filterImportId = null;
        PageResourceQuestionResource response = api.getQuestions(size, page, order, filterSearch, filterIdset, filterCategory, filterTagset, filterType, filterPublished, filterImportId);
    ...
    public void updateQuestionTemplateTest() throws ApiException {
        String id = null;
        QuestionTemplateResource questionTemplateResource = null;
        api.updateQuestionTemplate(id, questionTemplateResource);
