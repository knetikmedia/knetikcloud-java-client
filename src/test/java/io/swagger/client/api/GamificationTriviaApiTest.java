...
public class GamificationTriviaApiTest {
    ...
    public void getListUsingGET1Test() throws ApiException {
        ...
        Integer page = null;
        String order = null;
        PageImportJobResource response = api.getListUsingGET1(filterVendor, filterCategory, filterName, filterStatus, size, page, order);
    ...
    public void getQuestionTemplatesUsingGETTest() throws ApiException {
        ...
        Integer page = null;
        String order = null;
        PageQuestionTemplateResource response = api.getQuestionTemplatesUsingGET(size, page, order);
    ...
    public void getQuestionsUsingGETTest() throws ApiException {
        ...
        Boolean filterPublished = null;
        Long filterImportId = null;
        PageQuestionResource response = api.getQuestionsUsingGET(size, page, order, filterSearch, filterIdset, filterCategory, filterTagset, filterType, filterPublished, filterImportId);
