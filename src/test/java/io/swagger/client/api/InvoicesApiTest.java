...
public class InvoicesApiTest {
    ...
    public void getInvoiceHistoryUsingGETTest() throws ApiException {
        ...
        Integer page = null;
        String order = null;
        PageResourceInvoiceResource response = api.getInvoiceHistoryUsingGET(filterUser, filterEmail, filterFulfillmentStatus, filterPaymentStatus, filterItemName, filterCreatedDate, size, page, order);
    ...
    public void getLogsUsingGETTest() throws ApiException {
        ...
        Integer size = null;
        Integer page = null;
        PageResourceInvoiceLogEntry response = api.getLogsUsingGET(id, size, page);
