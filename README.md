...
* Password grant: 
 ...
 ```curl 
POST /oauth/token?grant_type=password## Getting Startedclient_id=web## Getting Startedusername=jdoe## Getting Startedpassword=68a4sd3sd
 ``` 
...
* Client credentials grant: 
 ...
 ```curl 
POST /oauth/token grant_type=client_credentials## Getting Startedclient_id=server-client-id## Getting Startedclient_secret=1s31dfas65d4f3sa651c3s54f 
```  
