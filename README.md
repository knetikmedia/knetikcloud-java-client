...
```
Use the provided token in sub-sequent requests to authenticate (see below). Make sure you refresh your token before it expires to avoid having to re-authenticate
